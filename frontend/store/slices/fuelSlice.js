...
export const createFuelRecord = createAsyncThunk('fuel/create', async (data, { rejectWithValue }) => {
  try {
...
export const updateFuelRecord = createAsyncThunk('fuel/update', async ({ id, data }, { rejectWithValue }) => {
  try {
...
export const deleteFuelRecord = createAsyncThunk('fuel/delete', async (id, { rejectWithValue }) => {
  try {
