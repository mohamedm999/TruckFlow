...
export const fetchTrailers = createAsyncThunk('trailers/fetchAll', async (_, { rejectWithValue }) => {
  try {
    ...
    const trailers = (response.data || []).map((trailer) => ({
      id: trailer._id,
...
export const createTrailer = createAsyncThunk('trailers/create', async (data, { rejectWithValue }) => {
  try {
...
export const updateTrailer = createAsyncThunk('trailers/update', async ({ id, data }, { rejectWithValue }) => {
  try {
...
export const deleteTrailer = createAsyncThunk('trailers/delete', async (id, { rejectWithValue }) => {
  try {
