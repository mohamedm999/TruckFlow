...
export const fetchTruck = createAsyncThunk('trucks/fetchOne', async (id, { rejectWithValue }) => {
  try {
...
export const createTruck = createAsyncThunk('trucks/create', async (data, { rejectWithValue }) => {
  try {
...
export const updateTruck = createAsyncThunk('trucks/update', async ({ id, data }, { rejectWithValue }) => {
  try {
...
export const deleteTruck = createAsyncThunk('trucks/delete', async (id, { rejectWithValue }) => {
  try {
