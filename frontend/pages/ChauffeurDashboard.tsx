...
import { Map, CheckCircle, Clock, AlertCircle, Fuel, TrendingUp, Plus, FileText, Truck as TruckIcon } from 'lucide-react';
...
export const ChauffeurDashboard: React.FC = () => {
  ...
  // Filter trips for current chauffeur
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <button
          onClick={() => navigate('/trips')}
          className="bg-slate-900 border border-slate-800 rounded-xl p-6 hover:border-orange-500 transition-all group"
        >
        ...
        <button
          onClick={() => navigate('/fuel')}
          className="bg-slate-900 border border-slate-800 rounded-xl p-6 hover:border-green-500 transition-all group"
        >
          <div className="flex items-center gap-4">
        ...
        <button
          ...
          className="bg-slate-900 border border-slate-800 rounded-xl p-6 hover:border-blue-500 transition-all group"
        >
          <div className="flex items-center gap-4">
                ...
                {completedTrips.slice(0, 5).map((trip) => (
                  <tr key={trip.id} className="hover:bg-slate-800/50 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-400">
                      {trip.actualArrival 
                        ? new Date(trip.actualArrival).toLocaleDateString('fr-FR')
                        : 'N/A'}
                    </td>
                  </tr>
                ))}
