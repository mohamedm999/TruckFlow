  ...
  const handleSubmit = async (e) => {
    ...
    if (editingRecord) {
      ...
      if (updateFuelRecord.fulfilled.match(result)) {
        ...
        setToast({ message: (result.payload) || 'Erreur lors de la modification', type: 'error' });
      }
    } else {
      ...
      if (createFuelRecord.fulfilled.match(result)) {
        ...
        setToast({ message: (result.payload) || 'Erreur lors de la création', type: 'error' });
      }
    }
