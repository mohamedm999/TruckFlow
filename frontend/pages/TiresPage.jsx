...
export const TiresPage= () => {
  ...
  const [deleteConfirm, setDeleteConfirm] = useState({ isOpen: false, tireId: null });
  ...
  const handleSubmit = async (e) => {
    ...
    if (editingTire) {
      ...
      if (updateTire.fulfilled.match(result)) {
        ...
        const errorMsg = (result.payload) || 'Erreur lors de la modification';
      ...
      if (createTire.fulfilled.match(result)) {
        ...
        const errorMsg = (result.payload) || 'Erreur lors de la création';
        setToast({ message: errorMsg, type: 'error' });
      }
    }
